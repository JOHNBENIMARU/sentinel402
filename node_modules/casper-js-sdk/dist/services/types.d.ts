...
type ReactorState = 'Initialize' | 'CatchUp' | 'Upgrading' | 'KeepUp' | 'Validate' | 'ShutdownForUpgrade';
...
export type TransformValue = 'Identity' | 'WriteContractWasm' | 'WriteContract' | 'WriteContractPackage' | {
